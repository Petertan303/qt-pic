...
struct qt_meta_stringdata_CLASSErrorDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSErrorDialogENDCLASS = QtMocHelpers::stringData(
    "ErrorDialog",
    "onCopyButtonClicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSErrorDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ErrorDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSErrorDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSErrorDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSErrorDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ErrorDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSErrorDialogENDCLASS.stringdata0))
